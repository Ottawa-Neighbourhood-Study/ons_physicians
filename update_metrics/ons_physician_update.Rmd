...
NOTE: Right now we're using data that is still being validated by summer students. We'll need to re-run these calculations once we have the confirmed data.

```{r, warning = FALSE, message = FALSE}
ottawa_docs <- read_csv("../data/docs_fulldata.csv") %>%
...
write_csv(drive_dist, file= "generated_distance_tables/walk_table.csv")
...
```{r message=FALSE, warning=FALSE}
walk_dist <- read_csv("generated_distance_tables/walk_table.csv")

physician_avg_dist_walk <- walk_dist %>%
